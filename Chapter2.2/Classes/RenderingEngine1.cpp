...
public:
	...
	void OnRotate( DeviceOrientation newOrientaton );
private:
...
void RenderingEngine1::OnRotate( DeviceOrientation newOrientation )
{
	...
	switch (newOrientation) { 
		...
		break;
		case DeviceOrientationPortraitUpsideDown: direction = vec3(0, -1, 0); 
		break;
		
		case DeviceOrientationFaceDown: direction = vec3(0, 0, -1); 
		break;
		
		case DeviceOrientationFaceUp: direction = vec3(0, 0, 1); 
		break;
		
		case DeviceOrientationLandscapeLeft: direction = vec3(+1, 0, 0); 
		break;
		
		case DeviceOrientationLandscapeRight: direction = vec3(-1, 0, 0); 
		break;
	}
...
void RenderingEngine1::Render() const
{
	...
	// draw the disc that caps off the base of he cone
	glVertexPointer( 3, GL_FLOAT, sizeof(Vertex), &m_disk[0].Position.x );
	glVertexPointer( 4, GL_FLOAT, sizeof(Vertex), &m_disk[0].Color.x );
